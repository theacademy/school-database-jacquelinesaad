    ...
    * Do not change any code outside of the placeholders provided.
    ...
    public List<Course> csCourses() {
        ...
        // YOUR CODE STARTS HERE
         ...
         String sql = "SELECT courseCode, courseDesc FROM course WHERE teacherId IN " +
    ...
    public List<StudentClassCount> studentsPerClass() {
        ...
        String sql = "SELECT c.courseCode, c.courseDesc, COUNT(DISTINCT cs.student_id) AS numStudents " +
                ...
                "JOIN student s on s.sid = cs.student_id " +
    ...
    public void addStudentToClass() {
        ...
        String sql = "INSERT INTO course_student (course_id, student_id) " +
                "SELECT cid, 123 FROM course WHERE courseCode = 'CS148'";
